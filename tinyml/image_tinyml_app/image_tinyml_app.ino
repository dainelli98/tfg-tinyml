 ...
 * OV7675 para recoger muestras de imagen sobre los que se usa un modelo
 * creado con TensorFlow para identificar la presencia de personas y si
 * estas llevan mascarilla.
 *
